<?php
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <img src="resources/images/iconos svg/logo_WALKER_UP.png" class="rounded mx-auto d-block" style="width:30%" alt="logotipo">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-4"><img src="resources/images/iconos svg/anda1.jpg" class="rounded mx-auto d-block" style="width:70%" alt=""></div>
          <div class="col-4"><img src="resources/images/iconos svg/anda2.jpg" class="rounded mx-auto d-block" style="width:70%" alt=""></div>
          <div class="col-4"><img src="resources/images/iconos svg/anda3.jpg" class="rounded mx-auto d-block" style="width:70%" alt=""></div>
        </div>
      </div>
      <hr>
      <div class="row">
        ...
        <div class="row justify-content-md-center">
          <div class="card col-4">
            <div class="card-body">
              ...
              <img src="resources/images/iconos svg/rasp.jpg" style="width:100%" alt="" class="card rounded mx-auto">
            </div>
          </div>
        </div>
        <hr>
        ...
        <div class="row mb-5">
          <div class="card col-4">
            <div class="card-body">
              ...
              <div class="col">
                <img src="resources/images/iconos svg/ultra.jpg" style="width:100%" alt="ultrasonico">
              </div>
              <div class="col">
                <img src="resources/images/iconos svg/sensor-ultrasonico-explicacion.png" class="card rounded mx-auto" style="width:100%" alt="">
              </div>
          ...
          <div class="card col-4">
            <div class="card-body">
              ...
              <img src="resources/images/iconos svg/dht11.jpg" class="card rounded mx-auto" style="width:100%" alt="dht11">
          ...
          <div class="card col-4">
            <div class="card-body">
              ...
              <img src="resources/images/iconos svg/vibracion.jpg" class="card rounded mx-auto" style="width:100%" alt="vibra">
        ...
        <div class="row mb-5">
          <div class="card col-4">
            <div class="card-body">
              ...
              <img src="resources/images/iconos svg/eme.png" class="rounded card mx-auto" style="width:60%" alt="eme">
              <img src="resources/images/iconos svg/boton.jpg" class="rounded card mx-auto" style="width:60%" alt="boton">
          ...
          <div class="card col-8">
            <div class="card-body">
              ...
              <img src="resources/images/iconos svg/lenguaje.jpg" class="rounded card mx-auto" style="width:100%" alt="lenguaje">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row mb-5">
        ...
        <div class="card col-6">
          <div class="card-body">
            <img src="resources/images/iconos svg/willy.jpg" class="card rounded mx-auto" style="width:60%" alt="perfil">
        ...
        <div class="card col-6">
          <div class="card-body">
            <img src="resources/images/iconos svg/calixto.jpg" class="card rounded mx-auto" style="width:60%" alt="perfil">
      ...
      <div class="row mb-5">
        <div class="card col-6">
          <div class="card-body">
            <img src="resources/images/iconos svg/valla.jpeg" class="card rounded mx-auto" style="width:60%" alt="perfil">
        ...
        <div class="card col-6">
          <div class="card-body">
            <img src="resources/images/iconos svg/yo.jpg" class="card rounded mx-auto" style="width:60%" alt="perfil">
      ...
      <div class="row justify-content-md-center">
        <div class="card col-6">
          <div class="card-body">
            <img src="resources/images/iconos svg/david.jpg" class="card rounded mx-auto" style="width:60%" alt="perfil">
